<header class="navbar">
  ...
  <a href="/"><span><img src="https://imgur.com/CHXWcf3.jpg" width="50px" height="50px"></span></a>
  ...
  <div id="mySidenav" class="sidenav">
    ...
    <h2 class="form-h2 navforms"><img class="logo-nav" src="https://imgur.com/KolJ8Tp.jpg" width="150px"></h2>
    <hr style="margin-bottom:0;"/>
    <h2 class="form-h2 navforms">Invoice Stuff</h2>
    <hr style="margin-bottom:0;"/>
    <div class="navforms forms">
      <a href="/catalogue/1"><p><span class="material-icons" style="font-size: 1.6rem;padding: 0 8px 0 5px;vertical-align: bottom;">&#xe3ad</span><span style="margin-bottom:5px;">View Taxes (Placeholder)</span></p></a>
    </div>
