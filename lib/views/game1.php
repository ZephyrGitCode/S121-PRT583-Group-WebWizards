<head>
	<meta charset="UTF-8" />
    <title>Recycle Bin Game</title>
	<script type="text/javascript" src="games/js/phaser.min.js"></script>
...
function preload() {
    ...
    game.load.image('ball', 'games/assets/images/ball.png');
    game.load.image('download', 'games/assets/images/download.png');
		game.load.image('side rim', 'games/assets/images/side_rim.png');
		game.load.image('front rim', 'games/assets/images/front_rim.png');

		game.load.image('win0', 'games/assets/images/win0.png');
		game.load.image('win1', 'games/assets/images/win1.png');
		game.load.image('win2', 'games/assets/images/win2.png');
		game.load.image('win3', 'games/assets/images/win3.png');
		game.load.image('win4', 'games/assets/images/win4.png');
		game.load.image('lose0', 'games/assets/images/lose0.png');
		game.load.image('lose1', 'games/assets/images/lose1.png');
		game.load.image('lose2', 'games/assets/images/lose2.png');
		game.load.image('lose3', 'games/assets/images/lose3.png');
		game.load.image('lose4', 'games/assets/images/lose4.png');

		game.load.audio('score', 'games/assets/audio/score.wav');
		game.load.audio('backboard', 'games/assets/audio/backboard.wav');
		game.load.audio('whoosh', 'games/assets/audio/whoosh.wav');
		game.load.audio('fail', 'games/assets/audio/fail.wav');
		game.load.audio('spawn', 'games/assets/audio/spawn.wav');
...
function create() {
  ...
  game.physics.p2.gravity.y = 0;
	...
	current_score_text = game.add.text(187, 350, '', { font: 'Arial', fontSize: '40px', fill: '#000', align: 'center' }); // 300, 500
	current_best_text = game.add.text(143, 281, '', { font: 'Arial', fontSize: '20px', fill: '#000', align: 'center' });// 230, 450
	current_best_score_text = game.add.text(187, 350, '', { font: 'Arial', fontSize: '40px', fill: '#00e6e6', align: 'center' }); // 300, 500

	download = game.add.sprite(99, 30, 'download'); // 141, 100
	left_rim = game.add.sprite(120, 150, 'side rim'); // 241, 296
	right_rim = game.add.sprite(279, 150, 'side rim'); // 398, 296
	...
	instructions.innerHTML = "Instructions: Quickly drag the paper to shoot the paper into the bin!";
...
function update() {
	...
	if (ball && ball.body.velocity.y > 0) {
		front_rim = game.add.sprite(117, 179, 'front rim');
		ball.body.collides([collisionGroup], hitRim, this);
	}

	if (ball && ball.body.velocity.y > 0 && ball.body.y > 188 && !ball.isBelowdownload) {
...
function createBall() {
	...
	spawn.play();
	ball = game.add.sprite(xpos, 500, 'ball');
